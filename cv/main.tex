...
\begin{itemize}
    \item Designed a TensorFlow/Keras Siamese network for paraphrase identification, fusing sentence embeddings with Jaccard and fuzzy-matching features and comparing four merge strategies.

    \item Built an augmentation pipeline generating \textbf{7{,}400+ synthetic samples} with class weighting, evaluated via ROC curves, confusion matrices, and feature importance analysis.
\end{itemize}

\textbf{Other projects:}
\href{https://tinyurl.com/59uzaj9r}{Stock price forecasting --- ARIMA vs.\ LSTM};
\href{https://github.com/saifibnaezhararko/SmartCare-Healthcare-Based-Django-website-}{SmartCare}, a full-stack Django healthcare management platform;
\href{https://github.com/saifibnaezhararko/CSE423_Lab-Project-3D-Ball-Roller}{3D Ball Roller}, a physics-based OpenGL game built from scratch in Python.
...
\begin{itemize}
    \item Recognized for sustained contributions to the global quantum community through education, mentoring, and content creation; lead workshops and mentor early-career researchers on Qiskit-based projects.

    \item Create quantum computing tutorials and learning resources, support the Qiskit community on official Discord and GitHub channels, and organize outreach events and hackathons.
\end{itemize}
...
\textbf{Web \& Tools:} & Django, HTML/CSS, OpenGL, Git, Linux, Jupyter, LaTeX \\
...
Lecturer, Department of CSE, School of Data and Sciences \\
